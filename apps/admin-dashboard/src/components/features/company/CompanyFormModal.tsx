...
const STATUS_OPTIONS = [
  ...
  { value: 'MAINTENANCE', label: '점검 중', icon: '🔧', color: 'bg-yellow-100 text-yellow-800' },
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="bg-gray-50 rounded-xl p-5">
                  <div className="flex items-center space-x-2 mb-4">
                    ...
                    <h3 className="text-base font-medium text-gray-900">주소 정보</h3>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    {/* 상세주소 */}
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1.5">상세주소</label>
                      <input
                        type="text"
                ...
                <div className="bg-gray-50 rounded-xl p-5">
                  <div className="flex items-center space-x-2 mb-4">
                    ...
                    <h3 className="text-base font-medium text-gray-900">추가 정보</h3>
                  </div>

                  <div className="space-y-4">
                    {/* 회사 설명 */}
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1.5">회사 설명</label>
                      <textarea
                        rows={3}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      {/* 운영 상태 */}
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1.5">운영 상태</label>
                        <div className="grid grid-cols-3 gap-2">
