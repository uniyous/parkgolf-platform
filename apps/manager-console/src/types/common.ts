 ...
 * 공통 API 타입 정의
 *
 * manager-console, user-app-web에서 동일한 구조를 사용합니다.
 */
...
export type BffErrorCode =
  ...
  // 친구 에러 (FRIEND_xxx)
  | 'FRIEND_001' // 친구 요청을 찾을 수 없습니다
  | 'FRIEND_002' // 자기 자신에게 친구 요청을 보낼 수 없습니다
  | 'FRIEND_003' // 이미 친구입니다
  | 'FRIEND_004' // 이미 친구 요청을 보냈습니다
  | 'FRIEND_005' // 이미 처리된 요청입니다
  | 'FRIEND_006' // 이 요청을 처리할 권한이 없습니다
  // 예약 에러 (BOOK_xxx)
  ...
  | 'CHAT_003' // 권한이 없습니다
  // 알림 에러 (NOTI_xxx)
  | 'NOTI_001' // 알림을 찾을 수 없습니다
  | 'NOTI_002' // 알림 발송에 실패했습니다
  | 'NOTI_003' // 알림 템플릿을 찾을 수 없습니다
  | 'NOTI_004' // 유효하지 않은 알림 타입입니다
  | 'NOTI_005' // 알림 전달에 실패했습니다
  // 결제 에러 (PAY_xxx)
  | 'PAY_001' // 결제 정보를 찾을 수 없습니다
  | 'PAY_002' // 이미 승인된 결제입니다
  | 'PAY_003' // 이미 취소된 결제입니다
  | 'PAY_004' // 결제 금액이 일치하지 않습니다
  | 'PAY_005' // 결제 상태가 올바르지 않습니다
  | 'PAY_006' // 결제 승인에 실패했습니다
  | 'PAY_007' // 결제 취소에 실패했습니다
  | 'PAY_008' // 결제 유효 시간이 만료되었습니다
  | 'PAY_009' // 유효하지 않은 카드입니다
  | 'PAY_010' // 잔액이 부족합니다
  | 'PAY_011' // 결제 한도를 초과했습니다
  // 환불 에러 (REFUND_xxx)
  | 'REFUND_001' // 환불 정보를 찾을 수 없습니다
  | 'REFUND_002' // 이미 환불 처리된 결제입니다
  | 'REFUND_003' // 환불 금액이 결제 금액을 초과합니다
  | 'REFUND_004' // 환불 처리에 실패했습니다
  | 'REFUND_005' // 환불 계좌 정보가 올바르지 않습니다
  // 빌링 에러 (BILLING_xxx)
  | 'BILLING_001' // 빌링키를 찾을 수 없습니다
  | 'BILLING_002' // 빌링키 발급에 실패했습니다
  | 'BILLING_003' // 이미 등록된 카드입니다
  | 'BILLING_004' // 자동결제에 실패했습니다
  // 유효성 검증 에러 (VAL_xxx)
  ...
  | 'SYS_005' // 서비스 점검 중입니다
  // 날씨 에러 (WEATHER_xxx)
  | 'WEATHER_001' // 유효하지 않은 좌표입니다
  | 'WEATHER_002' // 위치 정보를 찾을 수 없습니다
  | 'WEATHER_003' // 예보 정보를 조회할 수 없습니다
  // 기상청 API 에러 (KMA_xxx)
  | 'KMA_001' // 기상청 API 오류가 발생했습니다
  | 'KMA_002' // 기상청 API 응답 시간 초과
  | 'KMA_003' // 기상청 서비스에 연결할 수 없습니다
  | 'KMA_004' // 기상청 API 키가 유효하지 않습니다
  | 'KMA_005' // 해당 시간대의 날씨 데이터가 없습니다
  // 위치 에러 (LOCATION_xxx)
  | 'LOCATION_001' // 주소를 찾을 수 없습니다
  | 'LOCATION_002' // 유효하지 않은 좌표입니다
  | 'LOCATION_003' // 검색에 실패했습니다
  // 카카오 API 에러 (KAKAO_xxx)
  | 'KAKAO_001' // 카카오 API 호출 중 오류가 발생했습니다
  | 'KAKAO_002' // 카카오 API 응답 시간 초과
  | 'KAKAO_003'; // 카카오 API 키가 설정되지 않았습니다
...
export const ERROR_MESSAGES: Record<string, string> = {
  ...
  // 기상청 API 에러
  KMA_001: '기상청 API 오류가 발생했습니다',
  KMA_002: '기상청 API 응답 시간이 초과되었습니다',
  KMA_003: '기상청 서비스에 연결할 수 없습니다',
  KMA_004: '기상청 API 키가 유효하지 않습니다',
  KMA_005: '해당 시간대의 날씨 데이터가 없습니다',
  // 위치 에러
  ...
  // 카카오 API 에러
  KAKAO_001: '카카오 API 호출 중 오류가 발생했습니다',
  KAKAO_002: '카카오 API 응답 시간이 초과되었습니다',
  KAKAO_003: '카카오 API 키가 설정되지 않았습니다',
};
