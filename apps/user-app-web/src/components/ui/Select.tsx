...
const SelectTrigger = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof SelectPrimitive.Trigger> & { glass?: boolean }
>(({ className, children, glass = false, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-10 w-full items-center justify-between rounded-xl border px-4 py-2 text-base shadow-sm',
      'ring-offset-white focus:outline-none focus:ring-2 focus:ring-offset-2',
      'disabled:cursor-not-allowed disabled:opacity-50',
      '[&>span]:line-clamp-1',
      glass
        ? 'bg-white/90 border-white/30 text-slate-800 focus:ring-white/20 backdrop-blur-sm'
  ...
  return (
    ...
    >
      <div className={cn('relative', className)}>
        <SelectTrigger className={triggerClassName} glass={glass}>
