...
| `FRIEND_` | 404/409/403/400 | FRIEND_001: 404, FRIEND_003~004: 409, FRIEND_006: 403, 나머지: 400 |
| `CHAT_` | 404/403 | CHAT_001~002: 404, CHAT_003: 403 |
| `NOTI_` | 404/400/500 | NOTI_001/003: 404, NOTI_004: 400, 나머지: 500 |
| `WEATHER_` | 400/404/503 | WEATHER_001: 400, WEATHER_002: 404, WEATHER_003: 503 |
| `KMA_` | 502/504/503/401/404 | KMA_001: 502, KMA_002: 504, KMA_003: 503, KMA_004: 401, KMA_005: 404 |
| `LOCATION_` | 404/400/503 | LOCATION_001: 404, LOCATION_002: 400, LOCATION_003: 503 |
| `KAKAO_` | 502/504/500 | KAKAO_001: 502, KAKAO_002: 504, KAKAO_003: 500 |
...
| 코드 | 메시지 | HTTP |
|------|--------|------|
| `FRIEND_001` | 친구 요청을 찾을 수 없습니다 | 404 |
| `FRIEND_002` | 자기 자신에게 친구 요청을 보낼 수 없습니다 | 400 |
| `FRIEND_003` | 이미 친구입니다 | 409 |
| `FRIEND_004` | 이미 친구 요청을 보냈습니다 | 409 |
| `FRIEND_005` | 이미 처리된 요청입니다 | 400 |
| `FRIEND_006` | 이 요청을 처리할 권한이 없습니다 | 403 |
...
| `CHAT_002` | 메시지를 찾을 수 없습니다 | 404 |
| `CHAT_003` | 권한이 없습니다 | 403 |

### 알림 (NOTI_xxx)

| 코드 | 메시지 | HTTP |
|------|--------|------|
| `NOTI_001` | 알림을 찾을 수 없습니다 | 404 |
| `NOTI_002` | 알림 발송에 실패했습니다 | 500 |
| `NOTI_003` | 알림 템플릿을 찾을 수 없습니다 | 404 |
| `NOTI_004` | 유효하지 않은 알림 타입입니다 | 400 |
| `NOTI_005` | 알림 전달에 실패했습니다 | 500 |

### 날씨 (WEATHER_xxx)

| 코드 | 메시지 | HTTP |
|------|--------|------|
| `WEATHER_001` | 유효하지 않은 좌표입니다 | 400 |
| `WEATHER_002` | 위치 정보를 찾을 수 없습니다 | 404 |
| `WEATHER_003` | 예보 정보를 조회할 수 없습니다 | 503 |

### 기상청 API (KMA_xxx)

| 코드 | 메시지 | HTTP |
|------|--------|------|
| `KMA_001` | 기상청 API 오류가 발생했습니다 | 502 |
| `KMA_002` | 기상청 API 응답 시간 초과 | 504 |
| `KMA_003` | 기상청 서비스에 연결할 수 없습니다 | 503 |
| `KMA_004` | 기상청 API 키가 유효하지 않습니다 | 401 |
| `KMA_005` | 해당 시간대의 날씨 데이터가 없습니다 | 404 |

### 위치 (LOCATION_xxx)

| 코드 | 메시지 | HTTP |
|------|--------|------|
| `LOCATION_001` | 주소를 찾을 수 없습니다 | 404 |
| `LOCATION_002` | 유효하지 않은 좌표입니다 | 400 |
| `LOCATION_003` | 검색에 실패했습니다 | 503 |

### 카카오 API (KAKAO_xxx)

| 코드 | 메시지 | HTTP |
|------|--------|------|
| `KAKAO_001` | 카카오 API 호출 중 오류가 발생했습니다 | 502 |
| `KAKAO_002` | 카카오 API 응답 시간 초과 | 504 |
| `KAKAO_003` | 카카오 API 키가 설정되지 않았습니다 | 500 |
