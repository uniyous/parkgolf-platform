    ...
    subgraph GCP ["GCP Project: parkgolf-uniyous<br/>Region: asia-northeast3 (Seoul)"]
        ...
        subgraph GKE ["GKE Autopilot Cluster: parkgolf-env-cluster"]
            ...
            subgraph BFF ["BFF Layer"]
                ADMIN_API["manager-bff"]
                USER_API["consumer-bff"]
...
|------|---------|-------------|
| `/api/admin/*` | manager-bff | Admin/Platform API |
| `/api/user/*` | consumer-bff | User API |
| `/socket.io/*` | chat-gateway | WebSocket (Socket.IO) |
| `/chat/*` | chat-gateway | 채팅 REST |
| `/notification/*` | chat-gateway | 알림 REST |
| `/webhook/*` | billing-service | 결제 웹훅 (Toss) |
...
3개 앱: manager-console, marketplace-console, user-app-web

| App | Dev Site | Prod Site |
|-----|----------|-----------|
| manager-console | parkgolf-manager-dev | parkgolf-manager |
| marketplace-console | parkgolf-marketplace-dev | parkgolf-marketplace |
