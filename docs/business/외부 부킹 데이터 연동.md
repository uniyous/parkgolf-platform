...
flowchart TB
  ...
  %% ── Phase 0 스타일 (계약) ──
  style CONTRACT fill:#ffb74d,stroke:#ef6c00,stroke-width:2px,color:#fff
  style C1 fill:#ffb74d,stroke:#ef6c00,color:#fff
  ...
  style C6 fill:#ffb74d,stroke:#ef6c00,color:#fff

  %% ── 1단계 스타일 (동기화) ──
  style STAGE1 fill:#81c784,stroke:#2e7d32,stroke-width:2px,color:#fff
  style S1 fill:#81c784,stroke:#2e7d32,color:#fff
  ...
  %% ── 2단계 스타일 (부킹) ──
  style STAGE2 fill:#64b5f6,stroke:#1565c0,stroke-width:2px,color:#fff
  style OUTBOUND fill:#64b5f6,stroke:#1565c0,color:#fff
  style O1 fill:#64b5f6,stroke:#1565c0,color:#fff
  ...
  style O7 fill:#64b5f6,stroke:#1565c0,color:#fff
  style INBOUND fill:#64b5f6,stroke:#1565c0,color:#fff
  style I1 fill:#64b5f6,stroke:#1565c0,color:#fff
  style I2 fill:#64b5f6,stroke:#1565c0,color:#fff
  style I3 fill:#64b5f6,stroke:#1565c0,color:#fff
  style I4 fill:#64b5f6,stroke:#1565c0,color:#fff
  style I5 fill:#64b5f6,stroke:#1565c0,color:#fff

  %% ── 취소 스타일 ──
  style CANCEL fill:#ef9a9a,stroke:#c62828,color:#fff
  style X1 fill:#ef9a9a,stroke:#c62828,color:#fff
  style X2 fill:#ef9a9a,stroke:#c62828,color:#fff
  style X3 fill:#ef9a9a,stroke:#c62828,color:#fff
  style X4 fill:#ef9a9a,stroke:#c62828,color:#fff

  %% ── 결제 스타일 ──
  style PAYMENT fill:#ce93d8,stroke:#7b1fa2,stroke-width:2px,color:#fff
  style P1 fill:#ce93d8,stroke:#7b1fa2,color:#fff
  ...
  %% ── 모니터링 스타일 ──
  style MONITOR fill:#90a4ae,stroke:#455a64,stroke-width:2px,color:#fff
  style MON1 fill:#90a4ae,stroke:#455a64,color:#fff
  style MON2 fill:#90a4ae,stroke:#455a64,color:#fff
  style MON3 fill:#ef9a9a,stroke:#c62828,color:#fff
```
