...
**골프장 관리자 (manager-console)** 가 자기 골프장에 적용할 감면 유형과 할인율을 설정한다.
...
### 10-5. marketplace-console — 감면 승인/통계
...
manager-console: 감면 정책 CRUD, 감면 현황 조회
marketplace-console: 감면 승인/반려, 통계 대시보드
```
...
| [계정 삭제 정책](./account-deletion.md) | 탈퇴 시 감면 자격/증빙 삭제 |
