...
// ============================================
// 부킹 에러 (BOOKING_xxx) — frontdesk 예약/체크인 (UNI-114)
// ============================================
export const BookingErrors = defineErrors({
  NOT_FOUND: { code: 'BOOKING_001', message: '예약을 찾을 수 없습니다', httpStatus: 404 },
  INVALID_STATE: { code: 'BOOKING_002', message: '예약 상태가 올바르지 않습니다', httpStatus: 409 },
  SLOT_UNAVAILABLE: { code: 'BOOKING_003', message: '예약 가능한 슬롯이 아닙니다', httpStatus: 409 },
  INVALID_PLAYER_COUNT: { code: 'BOOKING_004', message: '인원이 올바르지 않습니다', httpStatus: 400 },
});
