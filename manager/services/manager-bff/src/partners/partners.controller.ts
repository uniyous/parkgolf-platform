 ...
 * 파트너 연동 관리 API
 *
 * marketplace-console: 전체 파트너 CRUD, 설정, 모니터링
 * manager-console: 내 골프장 연동 현황 (clubId 기반)
 */
@ApiTags('Partners')
@ApiBearerAuth()
...
export class PartnersController {
  ...
  // ──────────────────────────────────────────────
  // marketplace-console: 파트너 설정 전체 CRUD
  // ──────────────────────────────────────────────
  ...
  // ──────────────────────────────────────────────
  // marketplace-console: 파트너 기준 동기화/매핑 조회
  // ──────────────────────────────────────────────
