...
// Health Check 설정
const BFF_ENDPOINTS = [
  { name: 'manager-bff', url: `${BASE_URL}/api/admin/health` },
  { name: 'consumer-bff', url: `${BASE_URL}/api/user/health` },
];
...
const ALL_SERVICES = ['manager-bff', 'consumer-bff', 'iam-service', 'club-service', 'booking-service', 'chat-gateway', 'chat-service', 'notify-service'];
