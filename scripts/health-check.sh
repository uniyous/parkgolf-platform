...
# 서비스 정의
# 핵심 서비스만 포함
SERVICES="iam-service:3011 club-service:3012 booking-service:3013 manager-bff:3091 manager-console:3000 user-webapp:3002"
...
echo "================"
for service_info in "manager-bff:3091 consumer-bff:3092 iam-service:3011 club-service:3012 booking-service:3013"; do
    IFS=':' read -r service port <<< "$service_info"
