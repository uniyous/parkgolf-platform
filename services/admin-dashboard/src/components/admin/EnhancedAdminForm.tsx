...
export const EnhancedAdminForm: React.FC<EnhancedAdminFormProps> = ({
  ...
  const roleOptions = [
    { 
      ...
      icon: '👁️',
      permissions: ['데이터 조회', '보고서 열람']
    },
    { 
      value: 'MODERATOR' as AdminRole, 
      label: '운영자', 
      description: '예약 관리 및 기본 업무 수행',
      icon: '⚙️',
      permissions: ['예약 관리', '고객 관리', '데이터 조회']
    },
    { 
      value: 'ADMIN' as AdminRole, 
      label: '관리자', 
      description: '대부분의 관리 기능 수행',
      icon: '👨‍💼',
      permissions: ['코스 관리', '예약 관리', '고객 관리', '보고서 관리']
    },
    { 
      ...
      icon: '👑',
      permissions: ['시스템 관리', '관리자 관리', '모든 기능']
    },
  ];
