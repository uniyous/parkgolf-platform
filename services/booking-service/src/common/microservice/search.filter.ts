export class SearchFilterSort {
  ...
  static of(searchKeywords: string, filter: Record<string, any>, sort: Record<string, any>) {
...
export class FilterSort {
  ...
  static of(filter: Record<string, any>, sort: Record<string, any>) {
...
export class Filter {
  ...
  static of(filter: Record<string, any>) {
