...
export class GamesService {
  ...
  async getGames(clubId?: number, page = 1, limit = 20): Promise<ApiResponse<GameListResponse>> {
  ...
  async searchGames(searchDto: SearchGamesDto): Promise<ApiResponse<GameListResponse>> {
  ...
  async getAvailableTimeSlots(gameId: number, date: string): Promise<ApiResponse<GameTimeSlotResponseDto[]>> {
